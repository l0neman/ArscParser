...
public class ObjectTOutput implements Closeable {
  ...
  /*
    构建类内部成员列表。
   */
  public ObjectTOutput(String in, String out) throws IOException {
  ...
  public ObjectTOutput(String in, String out, boolean bigEndian) throws IOException {
    this(in, out);
